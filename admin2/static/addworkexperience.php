...
<link rel="stylesheet" href="css/mydetails.css">
            ...
            <main class="content">
                ...
                <form action="php/add/workexperience.php" method="post" enctype="multipart/form-data">
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Adding new work experience</h1>
					...
					<div class="row">
						<div class="col-12">
                            ...
                            <div class="card">
								...
								<div class="card-body">
									<input type="text" class="form-control" name="Duration" placeholder="2019-2020">
								</div>
							</div>
