        ...
        <div id="loadingIndicator"></div>  
            <main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">Adding new Recent Work</h1>
					...
					<div class="row">
						<div class="col-12">
							...
							<div class="card">
								...
								<div class="card-body">
									<input type="text" class="form-control" id="Name" placeholder="Enter skill Title">
								</div>
							</div>
                            ...
                            <div class="card">
								...
								<div class="card-body">
									<input type="text" class="form-control" id="Type" placeholder="Enter skill Title">
								</div>
							</div>
                            <div class="card">
								<div class="card-header">
								...
								<div class="card-body">
									<input type="url" class="form-control" id="Link" placeholder="Enter skill Title">
								</div>
							</div>
