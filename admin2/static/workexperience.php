            ...
            <main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						...
						<a class="badge bg-dark text-white ms-2" href="./addworkexperience.php">
                                    ...
                                    <table id="customerTable" class="table table-striped" style="width:100%">
                                        ...
                                        <tbody class="contentable">
                                            ...
                                            <tr>
                                                ...
                                                <td> 
                                                        <a href="editworkexperience.php?id=<?php echo $row['Id']; ?>"><img src="../../Assets/web/edit1.png" alt="" style="width:25px;height:25px; margin-right:5px;"></a>
            ...
            Swal.fire({
                ...
                confirmButtonText: 'Yes, delete it!'
                    ...
                    if (result.isConfirmed) {
                        ...
                        window.location.href = 'php/delect/WorkExperience.php?delete_id=' + idnum;
